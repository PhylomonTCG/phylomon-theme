...
/* 
 * This file contains code that is was originally found in the functions.php file of the sandbox theme
 *  
 *
 */
...
function sandbox_titlemeta()
{
?>

<div class="entry-comments">
	<span>with <?php comments_number('zero comments', 'one comment', 'more comments'); ?></span>
</div>
<?php
}
/*
...
function sandbox_postmeta()
{
?>

<div class="entry-meta">
	<div class="entry-meta-author-date">
		<span class="author vcard"><?php printf( __( 'Written by %s', 'sandbox' ),  get_the_author()  ) ?> 
		<?php edit_post_link(__("Edit"), '<span class="edit-link">',' </span>'); ?></span>
	
		<div class="entry-date">
			<abbr class="published" title="<?php the_time('Y-m-d\TH:i:sO') ?>">
				<?php unset($previousday); printf( __( '%1$s at %2$s', 'sandbox' ), the_date( '', '', '', false ), get_the_time() ) ?>
			</abbr>
		</div>
	</div>
