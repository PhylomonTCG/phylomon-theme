...
<?php if ( get_comment_type() == "comment" ) : ?>
						<li id="comment-<?php comment_ID() ?>" class="<?php sandbox_comment_class() ?>">
							...
							<div class="comment-meta"><?php printf(__('Posted %1$s at %2$s <span class="meta-sep no-print">|</span> <a href="%3$s" class="no-print" title="Permalink to this comment">Permalink</a>', 'sandbox'),
										get_comment_date(),
										get_comment_time(),
...
<?php else : ?>
							...
							<div class="form-labels-input-shell">
